...
namespace UnitTests.Application.Common.Exceptions
{
    public class ValidationExceptionTests
    {
        [Test]
        public void ShouldCreateAnEmptyErrorDictionary()
        {
        ...
        [Test]
        public void ShouldCreateASingleDictionaryError()
        {
        ...
        [Test]
        public void ShouldCreateAnExceptionWithDictionaryErrors()
        {
            var failures = new List<ValidationFailure>
            {
